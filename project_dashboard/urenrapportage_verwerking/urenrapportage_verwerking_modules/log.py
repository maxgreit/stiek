...
from urenrapportage_verwerking_modules.database import connect_to_database

def logging(logging_connection_string, klant, bron, log, script, scriptid, tabel=None):
